...
class Ticket {
  ...
  async save() {
    const query =
      "INSERT INTO tickets (title, description, status_id, priority_id, category, created_by, assigned_to) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *";
    const values = [
      this.title,
      this.description,
      this.status_id,
  ...
  static async findAll(statusId, userId) {
